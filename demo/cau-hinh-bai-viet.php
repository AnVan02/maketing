                ...
                <div class="grid-layout">
                        ...
                        <section class="card basic-info">
                            ...
                            <div class="card-header">
                                <div class="tabs-container">
                                    <button class="tab-btn active" data-tab="internet">
                                    ...
                                    <button class="tab-btn" data-tab="private">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            <path d="M7 11V7a5 5 0 0 0 1 10 0v4"></path>
                                        </svg>
                                        Dữ liệu riêng
                                    </button>
                                </div>
                    ...
                    <div class="column right">
                        ...
                        <div class="preview-text">
                            ...
                            <p>Xem ví dụ bên dưới để hiểu cách quy trình hoạt động và tạo ra nội dung hấp dẫn. Tất cả bài viết trên nền tảng đều được tạo từ công cụ này.</p><br>
                        </div>
