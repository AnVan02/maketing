        ...
        <div class="manager-right">
            <div class="form-card bounce-in">
                <div class="form-header">
                    <h2 class="form-title">Thêm cấu hình bài Facebook</h2>
                ...
                <div class="form-body">
                    ...
                    <div class="toggle-row">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <a href="#" style="font-size: 13px; color: #3b82f6; text-decoration: none;">+ Tạo ảnh bằng trợ lý A.I.</a>
                            <label class="switch"><input type="checkbox" id="toggle_image" checked><span class="slider"></span></label>
                        </div>
                    </div>

                    <div id="upload_area" style="border: 1px dashed #cbd5e1; padding: 20px; border-radius: 12px; text-align: center; color: #64748b; margin-top: 15px; cursor: pointer; background: #f8fafc;">
                        <i class="fas fa-paperclip" style="margin-right: 8px;"></i> Duyệt hình ảnh của bạn tại đây
                    </div>
