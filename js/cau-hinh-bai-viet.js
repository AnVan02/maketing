...
async function filterNewsAndGenerateOutline(crawledArticles, mainKeyword, secondaryKeywords, articleTitle, topK = 3) {
    ...
    try {
        ...
        const res = await fetch("https://caiman-warm-swan.ngrok-free.app/api/v1/ai/news-filterings", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "ngrok-skin-browser-warning": "true",
            },
    ...
    generateBtn.addEventListener('click', async function (e) {
        ...
        try {
            ...
            if (outlineData && outlineData.article_outline) {
                ...
                // Chuyển dữ liệu sang outline editor
                ...
                const sessionData = {
                    ...
                    config: {
                        ...
                        secondary_keywords: secondary_keywords,  // ✅ SỬA
                        title: title,
                        type: content_type,
                        bot: bot,
