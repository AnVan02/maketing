document.addEventListener('DOMContentLoaded', async () => {
    ...
    window.refreshPostsTable = async function () {
        ...
        try {
            ...
            // Endpoint lấy danh sách thường là /facebook/publish/posts (phương thức GET)
            console.log("Fetching posts from /facebook/publish/posts...");
            const response = await apiRequest('/facebook/publish/posts');
            ...
            if (emptyState) {
                ...
                emptyState.querySelector('p').textContent = `Lỗi tải dữ liệu: ${error.message}`;
            }
        }
    };
