...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* HEADER */
        header { padding: 25px 0; position: absolute; width: 100%; z-index: 10; }
        .nav-wrap { display: flex; justify-content: space-between; align-items: center; }
        .logo { color: white; font-weight: 900; font-size: 24px; }
        nav a { color: rgba(255,255,255,0.8); text-decoration: none; margin-left: 30px; font-size: 14px; font-weight: 600; }
        ...
        .tag { background: rgba(255,255,255,0.1); padding: 5px 15px; border-radius: 20px; font-size: 12px; border: 1px solid rgba(255,255,255,0.2); }

        .hero-stats { display: flex; gap: 40px; margin-top: 50px; }
        .stat-item strong { font-size: 30px; display: block; }
        .stat-item span { font-size: 12px; opacity: 0.7; }

        /* CỤM ẢNH HERO (PHẢI) */
        .hero-images { flex: 1; position: relative; height: 450px; }
        .ais-watermark {
            position: absolute; right: -50px; top: 0; font-size: 200px; font-weight: 900;
            color: transparent; -webkit-text-stroke: 1px rgba(255,255,255,0.1); z-index: 0;
        }
        .img-card { position: absolute; border-radius: 15px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.4); }
        .img-1 { width: 180px; height: 250px; left: 0; top: 100px; z-index: 2; }
        .img-2 { width: 250px; height: 350px; left: 140px; top: 0; z-index: 3; }
        .img-3 { width: 200px; height: 150px; left: 350px; top: 150px; z-index: 1; }
        .img-card img { width: 100%; height: 100%; object-fit: cover; }

        /* PARTNERS */
        .partners { padding: 60px 0; text-align: center; }
        .partners p { color: var(--bright-blue); font-weight: 700; font-size: 12px; text-transform: uppercase; margin-bottom: 30px; }
        .partner-logos { display: flex; justify-content: center; gap: 50px; align-items: center; opacity: 0.5; filter: grayscale(1); }
        .partner-logos img { height: 30px; }

        /* SECTION PROPERNESS */
        .properness { padding: 100px 0; text-align: center; position: relative; }
        .bg-text-large { 
            font-size: 120px; font-weight: 900; color: #f0f4f8; 
            position: absolute; width: 100%; top: 50px; z-index: -1; 
        }
        .properness h2 { font-size: 24px; color: var(--dark-blue); margin-bottom: 60px; }

        .timeline { position: relative; max-width: 800px; margin: 0 auto; }
        .timeline::before { 
            content: ''; position: absolute; left: 50%; width: 1px; background: #eee; height: 100%; top: 0; 
        }
        .step { margin-bottom: 80px; position: relative; z-index: 2; background: white; padding: 20px; display: inline-block; width: 100%; }
        .step-num { font-size: 40px; font-weight: 800; color: #333; display: block; margin-bottom: 10px; }
        .step h3 { font-size: 20px; margin-bottom: 10px; }
        .step p { font-size: 14px; color: var(--text-gray); max-width: 400px; margin: 0 auto; }

        /* FEATURES GRID */
        .grid-features { display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 80px; }
        .feat-card { border-radius: 20px; overflow: hidden; background: #fff; box-shadow: 0 10px 30px rgba(0,0,0,0.05); position: relative; height: 350px;}
        .feat-left { 
            ...
            background-size: cover; padding: 50px; display: flex; flex-direction: column; justify-content: center;
        }
        .feat-left h3 { font-size: 24px; color: var(--dark-blue); max-width: 300px; margin-bottom: 20px; }
        .btn-round { width: 50px; height: 50px; border-radius: 50%; background: #eef5ff; color: var(--bright-blue); display: flex; align-items: center; justify-content: center; text-decoration: none; }
        
        .feat-right { padding: 30px; display: flex; flex-direction: column; }
        .feat-right img { width: 100%; border-radius: 10px; margin-top: auto; }

        /* FAQ */
        .faq { padding: 80px 0; text-align: center; }
        .faq h2 { margin-bottom: 40px; color: var(--dark-blue); }
        .faq-item { 
            max-width: 800px; margin: 0 auto 15px; background: #fff; border: 1px solid #eee; 
            padding: 20px 30px; border-radius: 12px; display: flex; justify-content: space-between; align-items: center;
            cursor: pointer; transition: 0.3s;
        }
        .faq-item:hover { border-color: var(--bright-blue); box-shadow: 0 5px 15px rgba(0,0,0,0.05); }
        .faq-item i { color: #87ceeb; }

        @media (max-width: 992px) {
            .hero-flex { flex-direction: column; text-align: center; }
            .search-box { margin: 0 auto 20px; }
