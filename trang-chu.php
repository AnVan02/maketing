    ...
    <header class="main-header">
        <div class="container">
            ...
            <div class="header-actions">
                <a href="#" class="btn-login"><i class="fa-solid fa-file-signature"></i> Lưu nháp</a>
                <div class="user-avatar-small"><img src="images/1.png" alt=""></div>
            </div>
        </div>
    </header>
        ...
        <section class="hero">
            ...
            <div class="hero-content container">
                ...
                <div class="hero-actions">
                    <a href="#" class="btn-pill btn-blue">Xem hướng dẫn</a>
                    <a href="dang-nhap.php" class="btn-pill btn-outline">Đăng ký</a>
                </div>

                <div class="hero-footer-tags">
                    <span><i class="fa-solid fa-check"></i> Dễ dàng sử dụng</span>
                    <span><i class="fa-solid fa-check"></i> Tiết kiệm 90% chi phí</span>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="partners-slider">
                    ...
                    <div class="logos-wrap">
                        <div class="logo-item"><img src="images/logo-vinamilk.png" alt="Vinamilk"></div>
                        <div class="logo-item"><img src="images/logo-7eleven.png" alt="7-Eleven"></div>
                        <div class="logo-item"><img src="images/logo-vingroup.png" alt="Vingroup"></div>
                        <div class="logo-item"><img src="images/logo-bidv.png" alt="BIDV"></div>
                    </div>
