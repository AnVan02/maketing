...
<link rel="stylesheet" href="./css/trang-thai-xu-ly.css">
...
<main class="content-area-thinking">
    ...
    <div class="thinking-container">
        <h2 class="thinking-title">SẮP HOÀN TẤT...</h2>
        ...
        <div class="time-estimate" id="countdown-timer">Còn khoảng 5 giây</div>
...
<script src="./js/trang-thai-xu-ly.js"></script>